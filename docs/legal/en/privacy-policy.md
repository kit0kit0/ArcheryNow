...
This policy applies to data handling for the **iOS** App. Paid purchases: see [Terms of Service](terms-of-service.md).
...
**(1) RevenueCat / Apple (billing)** — purchase status, restore; data may include purchase info, pseudonymous app user ID, device/OS info. See [RevenueCat Privacy](https://www.revenuecat.com/privacy). Payments are processed by **Apple**.

**(2) iCloud (Pro)** — database/backup JSON sync per Apple’s terms.

**(3) GitHub Issues** — feedback and requests; content and public profile data processed by **GitHub, Inc.** ([GitHub Privacy Statement](https://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement)).
...
**(5) Google AdMob / Google User Messaging Platform (ads and consent)** — used to show ads, manage consent, protect ad delivery, and measure ad performance. Google may process data such as the advertising identifier (IDFA, if allowed through ATT), device information, IP address, ad impressions/clicks, app usage signals, and consent status. See [Google Privacy Policy](https://policies.google.com/privacy) and [Google advertising technologies](https://policies.google.com/technologies/ads).
...
Under Japanese law you may request access, correction, deletion, etc. **No public email** — use [GitHub Issues](https://github.com/kit0kit0/ArcheryNow/issues) or methods we specify. We may verify identity.
...
[GitHub Issues](https://github.com/kit0kit0/ArcheryNow/issues) or **App Store** developer support.
